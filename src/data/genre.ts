import { fetchGenreByPlaylistId } from '@/components/api/playlists';
import { SpotifyArtist } from '@/interface/artist';
import { SpotifyGenre } from '@/interface/genre'
...
export function PlaylistGenres(artists: SpotifyArtist[]): SpotifyGenre[] {
